...
export default class FuerzasController {
  public async index({ request, response }: HttpContextContract) {
    ...
    if (combo) {
      return response.send({
        ...
        payload: await prisma.fuerza.findMany({
          orderBy: [
            { posicion: 'asc' },
            { nombre: 'asc' },
          ],
  ...
  public async store({ request, response }: HttpContextContract) {
    ...
    try {
      return response.send({
        ...
        payload: await prisma.fuerza.create({
          data: payload,
        }),
      })
    } catch(err) {
  ...
  public async show({ request, response }: HttpContextContract) {
    try {
      return response.send({
        ...
        payload: await prisma.fuerza.findUniqueOrThrow({
          where: {
            id: request.param('id'),
          },
        }),
  ...
  public async update({ request, response }: HttpContextContract) {
    ...
    try {
      return response.send({
        ...
        payload: await prisma.fuerza.update({
          where: {
            id: request.param('id'),
          },
          data: payload,
